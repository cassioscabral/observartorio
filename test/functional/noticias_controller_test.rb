...
class NoticiasControllerTest < ActionController::TestCase
  ...
  test "should create noticia" do
    assert_difference('Noticia.count') do
      post :create, noticia: { autor: @noticia.autor, conteudo: @noticia.conteudo, resumo: @noticia.resumo, titulo: @noticia.titulo }
    end
  ...
  test "should update noticia" do
    put :update, id: @noticia, noticia: { autor: @noticia.autor, conteudo: @noticia.conteudo, resumo: @noticia.resumo, titulo: @noticia.titulo }
    assert_redirected_to noticia_path(assigns(:noticia))
  end
